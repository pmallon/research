...
public class TradeDaoImpl implements TradeDao {
	...
	/**
	 * Using SHA-512 to ensure DB integrity ,will impact performance , depending on how 'secure' access to the DB system this
	 * can be removed or use a more secure hardware encryption.Balance between security risk and performance  
	 */
